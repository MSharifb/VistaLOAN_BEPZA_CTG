namespace VistaLOAN
{
    ...
    {
        private static string[] databaseKeys = new[] {"Default","LoanDB" };
        ...
        private static void RunMigrations(string databaseKey)
        {
            ...
            // remove these lines if you want VistaLOAN migrations to run on your DB.
            ...
            using (var sw = new StringWriter())
            {
                ...
                var runner = new RunnerContext(announcer)
                {
                    ...
                    Namespace = "VistaLOAN.Migrations." + databaseKey + "DB"
                };
