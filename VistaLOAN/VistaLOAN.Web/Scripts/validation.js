function fnValidate() {
    ...
    if (notValid > 0) {
      ...
      //  $("#ErrorMessage").html("<b>Please provide valid information for the required field(s).</b> ").css({ "color": "red", "text-align": "center" });
       // $("#ErrorMessage").html("Please provide valid information for the required field(s).").css({ "color": "red" }).addClass("alert alert-danger text-left");
        Q.notifyWarning("Please provide valid information for the required field(s).");
        return false;
    }
    else {
      //  $("#ErrorMessage").html("").removeClass("alert alert-danger text-left");
        return true;
    }
